...
import {Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle} from '@walgo-hub/ui/components/ui/card';
import {ChartConfig, ChartContainer, ChartTooltip, ChartTooltipContent} from '@walgo-hub/ui/components/ui/chart';
    ...
    <Card className="@container/card">
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 leading-none font-medium">
          Chrome leads with {(((chartData[0]?.visitors ?? 0) / (totalVisitors || 1)) * 100).toFixed(1)}
